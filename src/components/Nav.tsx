  ...
  return (
    <nav className="site-nav">
      ...
      <div className="nav-icons">
        ...
        <a href={socialLinks.linkedin} className="nav-icon" title="LinkedIn" aria-label="LinkedIn" target="_blank" rel="noopener noreferrer">
        ...
        <a href={socialLinks.github} className="nav-icon" title="GitHub" aria-label="GitHub" target="_blank" rel="noopener noreferrer">
          <svg width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
